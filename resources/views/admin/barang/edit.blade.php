                ...
                <form action="{{ route('admin.barang.update', $barang) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="fg">
                        ...
                        <input type="text" name="nama_barang" class="fc {{ $errors->has('nama_barang') ? 'err' : '' }}"
                            value="{{ old('nama_barang', $barang->nama_barang) }}" minlength="5" maxlength="80"
                    ...
                    <div class="frow">
                        <div class="fg">
                            ...
                            <div class="ig">
                                ...
                                <input type="number" name="harga" class="fc {{ $errors->has('harga') ? 'err' : '' }}"
                                    value="{{ old('harga', $barang->harga) }}" min="0" placeholder="0" required>
                            </div>
                        ...
                        <div class="fg">
                            ...
                            <input type="number" name="jumlah" class="fc {{ $errors->has('jumlah') ? 'err' : '' }}"
                                value="{{ old('jumlah', $barang->jumlah) }}" min="0" placeholder="0" required>
                    ...
                    <div class="fg">
                        ...
                        <p class="hint">JPG, PNG, WebP · Maks 2MB · Kosongkan jika tidak ingin mengubah</p>
        ...
        <div class="preview-sticky">
            <div class="card" style="overflow:hidden">
                <div id="foto-preview-wrap"
                    style="aspect-ratio:4/3;background:#ede8e0;display:flex;align-items:center;justify-content:center;overflow:hidden">
                    @if($barang->foto)
                        <img src="{{ asset('storage/' . $barang->foto) }}" style="width:100%;height:100%;object-fit:cover">
                    @else
                ...
                <div class="card-body" style="padding:12px 14px">
                    ...
                    <p id="prev-nama" style="font-size:14px;font-weight:600;margin-bottom:4px">{{ $barang->nama_barang }}
                    </p>
                    <p id="prev-harga" style="font-size:18px;font-weight:800;color:var(--accent)">
